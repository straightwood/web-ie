<template>
  <div id="main">
    ...
    <div id="bird">
    <img src="../../../assets/仙鹤飞翔A.gif" style="width:500px" id="birdA" @click='aclick'>
    <img src="../../../assets/仙鹤飞翔B.gif" style="width:450px" id="birdB" @click='bclick'>
    <img src="../../../assets/仙鹤飞翔C.gif" style="width:550px" id="birdC" @click='cclick'>
    <img src="../../../assets/仙鹤飞翔D.gif" style="width:470px" id="birdD" @click='dclick'>
    </div>
    ...
    <p id=q3content>A：《春秋》<br> 
       ...
       C：《中庸》<br> 
       D: 《论语》</p>
    <img src="../../../assets/correct.png" id="gou">
    <img src="../../../assets/wrong.png" id="cha">
    <Button type="text" id="nextqusBtn" @click="nextqus"></Button>
    <img id="wskaichang" src="../../../assets/wskaichang.png">
  </div>
</template>
...
.active1{
  background: url(../../../assets/瞄准.png) no-repeat;
}
p,input{
  margin: 10px;
}
...
#nextqusBtn{
  background: url("../../../assets/nextqusbutton.png")  no-repeat;
  position: absolute;
  right:80px;
  bottom:20px;
  width:250px;
