<template>
  <div id="main">
    ...
    <div id="bird">
    <img src="../../../assets/酒杯A.gif" style="width:125px" id="birdA" @click='aclick'>
    <img src="../../../assets/酒杯B.gif" style="width:125px" id="birdB" @click='bclick'>
    <img src="../../../assets/酒杯C.gif" style="width:125px" id="birdC" @click='cclick'>
    <img src="../../../assets/酒杯D.gif" style="width:125px" id="birdD" @click='dclick'>
    </div>
    ...
    <img id="wskaichang" src="../../../assets/wenskaichang.png">
  </div>
</template>
